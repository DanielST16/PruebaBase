...
<head>
    ...
    <head lang="es">
        ...
        <!-- font awesome -->
        <script src="https://kit.fontawesome.com/80db7214f9.js" crossorigin="anonymous"></script>
                        ...
                        <div class="site-header-shown">
                            ...
                            <div class="dropdown user-menu">
                                ...
                                <div class="dropdown-menu dropdown-menu-right pt-0" aria-labelledby="dd-user-menu">
                                    ...
                                    <h5 class="p-2 text-center bg-primary"><?= $_SESSION["Usuario"]?></h5>
                                    <a class="dropdown-item" href="PerfilAdmin.php"><span class="font-icon glyphicon glyphicon-user"></span>Perfil</a>
                                    <a class="dropdown-item" href="cambiarContraseñaAdmin.php"><span class="font-icon glyphicon glyphicon-lock"></span>Cambiar contraseña</a>

                                    <div class="dropdown-divider"></div>
                                    <a class="dropdown-item" href="../controlador/controladorCerrarSesion.php">
